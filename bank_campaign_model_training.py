...
bucket = storage_client.bucket("gcp-mlops-datastorage")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "gcp-ml-tutorial-470212.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://gcp-mlops-datastorage/bank_campaign_data/bank-campaign-training-data.csv"
    model_name = 'xgboost'
